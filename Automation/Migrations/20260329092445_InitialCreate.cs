        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportSeries = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsenceReason = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Руководство компании", null, "Администрация" },
                    { 2, "Финансовый отдел", null, "Бухгалтерия" },
                    { 3, "Информационные технологии", null, "IT отдел" },
                    { 4, "Продажи и маркетинг", null, "Отдел продаж" }
                });

            migrationBuilder.InsertData(
                table: "Positions",
                columns: new[] { "Id", "BaseSalary", "Name", "Requirements" },
                values: new object[,]
                {
                    { 1, 150000m, "Директор", null },
                    { 2, 80000m, "Главный бухгалтер", null },
                    { 3, 90000m, "Программист", null },
                    { 4, 60000m, "Менеджер по продажам", null },
                    { 5, 50000m, "Бухгалтер", null }
                });
